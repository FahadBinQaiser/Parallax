...
export default function CtaSection() {
  return (
    <section className="relative h-[80vh] flex flex-col md:flex-row items-center justify-center text-center py-14 bg-gradient-to-b from-[#080008] via-[#0a0a0a] to-[#100010]">
      <RadialGradient />
